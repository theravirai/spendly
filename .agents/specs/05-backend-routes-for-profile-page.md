...
- Response contains the seed user's email ("demo@outflow.com")
...
## Definition of done
- [ ] Logging in as the seed user (demo@outflow.com / demo123) shows "Demo User" and "demo@outflow.com" on the profile page — not the hardcoded strings
